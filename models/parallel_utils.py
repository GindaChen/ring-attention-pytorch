...
from mapping import reduce_from_tensor_model_parallel_region, gather_from_tensor_model_parallel_region, \
...
class ColumnParallelLinear(torch.nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self._linear_timer = nullcontext()
        # self._linear_timer = CudaTimer(linear_metric_name, layer_id=layer_id)
        self._communication_timer = nullcontext()
    ...
    def __init__(
        ...
        *,
        ...
        if not reduce_results and (bias and not skip_bias_add):
            print(
                "Warning: When not reduce the results, adding bias to the "
